...
console.log(renderTaskList(state.taskList));
...
function addNewTask() {
  state.taskList.push({id: state.taskList[state.taskList.length - 1].id + 1, description: state.inputtedText, complete:false});
  state.inputtedText = "";
